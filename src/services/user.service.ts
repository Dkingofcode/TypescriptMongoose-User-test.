import { CreateQuery, FilterQuery, QueryOptions, QueryFindBaseOptions }  from "mongoose";
...
export async function findUser(query: FilterQuery<UserDocument>, options: QueryFindBaseOptions = { lean: true }){
